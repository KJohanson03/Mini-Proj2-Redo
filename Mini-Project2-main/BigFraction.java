...
public class BigFraction {
  ...
  public String toString() {
   ...
   // if the denominator is = to zero just print out the numerator
  ...
  // Argument: BigFraction called second
  // Returns a Bigfraction 
  //
  // Multiplies the argument by the current Fraction
  ...
  // Returns a Bigfraction 
  //
  // Divides the argument by the current Fraction
